...
exports.purchase = function(req, res){
  ...
  stripe.charges.create({amount: req.session.totalCents , currency: 'usd', card: stripeToken, description: req.user.email || 'anonymous'}, function(err, charge){
    req.session.cart = [];
    req.session.save(function(){
      req.flash('success', 'Congratulations, your purchase was completed.');
